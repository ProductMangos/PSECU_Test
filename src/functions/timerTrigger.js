...
appInsights.setup("InstrumentationKey=0b942f1e-fb8a-463c-ad14-f37c17aa48d1;IngestionEndpoint=https://eastus-8.in.applicationinsights.azure.com/;LiveEndpoint=https://eastus.livediagnostics.monitor.azure.com/;ApplicationId=b7decbae-1b84-4734-bf5c-80cab2860717")
...
app.timer('timerTrigger', {
    ...
    handler: async (myTimer, context) => {
        ...
        try {
            ...
            await navigateAndPerformActions(page, context, responses, success, startTime, testStartTimer, uniqueId);
            await browser.close();
            ...
            context.log(`Failed to access the website: ${message}`);

            client.trackAvailability({
                id: uniqueId,
                name: "Temenos",
                success: false,
                message: `Failed to navigate: ${message}`,
                runLocation: "East US"
            });
